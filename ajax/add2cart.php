...
<form action="" method="POST">   
    <input name="qty" id="prodQuant" type="number" value="1">      
    <input type="hidden" name="pid" id="prodID" value="<?php echo "$pro"?>">
<!--    <input type="hidden" name="p" value="add_cart">-->
    <input type='hidden' name='function' value='add'/>
    <input class="btn btn-primary"  type="submit" value="Add to Cart" onclick="add2cart()">
</form>